(function(){
	...
	if (num==1) {
		...
		style = '<style>#login-welcome-bg{background:url(https://passport.58.com/pic2/ui6/my/images/login-2014chunjie_' + num + '.png?1) no-repeat 0 0;display:block;} #login-welcome-bg:hover{opacity:0.9;filter:alpha(opacity=90);}</style>';
